...
def parse_args():
    ...
    parser.add_argument('--weights', type=str,
                        default='weights/maskformer2_R101_bs16_90k/model_final_257ce8.pkl',
...
def main():
    ...
    # wrapped_model = Mask2FormerONNXWrapper(model).to(cfg.MODEL.DEVICE)
    wrapped_model = Mask2FormerONNXWrapper(model).to("cpu")
